<template>
  <div class="top-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <top-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="top-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="top-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="top-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="top-time-spinner__arrow top-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="top-time-spinner__arrow top-icon-arrow-down"></i>
        <ul class="top-time-spinner__list" ref="hours">
          <li
            class="top-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="top-time-spinner__arrow top-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="top-time-spinner__arrow top-icon-arrow-down"></i>
        <ul class="top-time-spinner__list" ref="minutes">
          <li
            class="top-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="top-time-spinner__arrow top-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="top-time-spinner__arrow top-icon-arrow-down"></i>
        <ul class="top-time-spinner__list" ref="seconds">
          <li
