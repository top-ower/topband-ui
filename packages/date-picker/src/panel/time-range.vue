<template>
  <transition
    ...
    <div
      v-show="visible"
      class="top-time-range-picker top-picker-panel top-popper"
      :class="popperClass">
      <div class="top-time-range-picker__content">
        <div class="top-time-range-picker__cell">
          <div class="top-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="top-time-range-picker__body top-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="top-time-range-picker__cell">
          <div class="top-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="top-time-range-picker__body top-time-panel__content">
            <time-spinner
      ...
      <div class="top-time-panel__footer">
        ...
        <button
          type="button"
          class="top-time-panel__btn confirm"
          @click="handleConfirm()"
