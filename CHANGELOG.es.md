...
- DropdownItem
  - Add icon prop to `top-dropdown-item` (by @gabrielboliveira in #14088)
- Input
...
- Menu
  - Add support for `top-menu-item` without index (by @georgyfarniev in #13298)
- Table
...
- Ahora el `class-name` y el `labtop-class-name` de la tabla son reactivos, #11626
...
- MessageBox
  - Corregida la clase `top-popup-parent--hidden` que no se eliminaba al abrir MessageBox sucesivamente, #11371
