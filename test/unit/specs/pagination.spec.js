...
describe('Pagination', () => {
  ...
  it('create', () => {
    ...
    // pager
    expect(elm.querySelector('ul.top-pager')).to.exist;
    // next
    expect(elm.querySelector('button.btn-next')).to.exist;
    // jumper
    expect(elm.querySelector('.top-pagination__jump')).to.exist;
    // ->
    expect(elm.querySelector('.top-pagination__rightwrapper')).to.exist;
  });
  ...
  it('set layout', () => {
    ...
    expect(elm.querySelector('button.btn-next')).to.exist;
    // not found jumper
    expect(elm.querySelector('.top-pagination__jump')).to.not.exist;
    // not found ->
    expect(elm.querySelector('.top-pagination__rightwrapper')).to.not.exist;
    // not found total
    expect(elm.querySelector('.top-pagination__total')).to.not.exist;
  });
  ...
  it('layout: all in right, need clear float', () => {
    ...
    const elm = vm.$el;
    let right_div = elm.querySelector('.top-pagination__rightwrapper');
  ...
  it('small', () => {
    ...
    expect(vm.$el.classList.contains('top-pagination--small')).to.true;
  });
  ...
  it('pageSizes', () => {
    ...
    expect(vm.$el.querySelector('.top-select-dropdown__item.selected')).to.property('textContent').include('35');
    expect([].slice.call(vm.$el.querySelectorAll('.top-select-dropdown__item'))
  ...
  it('pageSizes:not found pageSize', () => {
    ...
    expect(vm.$el.querySelector('.top-select-dropdown__item.selected')).to.property('textContent').include('10');
  });
  ...
  it('event:size-change', done => {
    ...
    setTimeout(_ => {
      vm.$el.querySelectorAll('li.top-select-dropdown__item')[1].click();
      setTimeout(_ => {
  ...
  it('pageSize > total', () => {
    ...
    const input = vm.$el.querySelector('.top-pagination__jump input');
  ...
  describe('click pager', () => {
    it('click ul', () => {
      ...
      vm.$el.querySelector('.top-pager').click();
    ...
    it('click li', () => {
      ...
      vm.$el.querySelectorAll('.top-pager li.number')[1].click();
    ...
    it('click next icon-more', () => {
      ...
      vm.$el.querySelector('.top-pager .more').click();
