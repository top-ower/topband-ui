...
- DropdownItem
  - Ajout de la propriété `icon` à `top-dropdown-item` (par @gabrielboliveira dans #14088)
- Input
...
- Menu
  - Ajout du support de `top-menu-item` sans index (par @georgyfarniev dans #13298)
- Table
...
- Maintenant `class-name` et `labtop-class-name` de Table sont réactifs, #11626
...
- MessageBox
  - Correction de la classe `top-popup-parent-hidden` qui n'était pas supprimée à l'ouverture successive de MessageBox, #11371
