...
```html
<template>
  <top-button type="text" @click="open">Cliquez pour ouvrir la MessageBox</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open2">Cliquez pour ouvrir la MessageBox</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open3">Cliquez pour ouvrir la MessageBox</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open4">Cliquez pour ouvrir la MessageBox</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open5">Cliquez pour ouvrir la MessageBox</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open6">Cliquez pour ouvrir la MessageBox</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open7">Cliquez pour ouvrir la MessageBox</top-button>
</template>
