...
```html
<template>
  <top-button :plain="true" @click="open">Afficher le message</top-button>
...
```html
<template>
  <top-button :plain="true" @click="openCenter">Texte centré</top-button>
</template>
...
```html
<template>
  <top-button :plain="true" @click="openHTML">Utiliser du HTML</top-button>
</template>
