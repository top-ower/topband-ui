...
```html
<template>
  <top-transfer v-model="value1" :data="data"></top-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <top-transfer
      ...
      @change="handleChange"
      :data="data">
      <top-button class="transfer-footer" slot="left-footer" size="small">操作</top-button>
      <top-button class="transfer-footer" slot="right-footer" size="small">操作</top-button>
    </top-transfer>
  </div>
