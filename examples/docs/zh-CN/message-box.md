...
```html
<template>
  <top-button type="text" @click="open">点击打开 Message Box</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open2">点击打开 Message Box</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open3">点击打开 Message Box</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open4">点击打开 Message Box</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open5">点击打开 Message Box</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open6">点击打开 Message Box</top-button>
</template>
...
```html
<template>
  <top-button type="text" @click="open7">点击打开 Message Box</top-button>
</template>
