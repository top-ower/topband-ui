...
<details>
  ...
  ```html
  <top-button @click="handleButtonClick">Click Me</top-button>
  ```
...
<details>
  ...
  <top-table-column label="操作">
    <template slot-scope="props">
      <top-button @click.native="showDetail(props.row)">查看详情</top-button>
    </template>
  </top-table-column>
  ```
  参数 `row` 即为对应行的数据。
...
<details>
  ...
  请阅读 Vue 文档 [Render Function](http://vuejs.org/v2/guide/render-function.html) 的相关内容。注意，使用 JSX 来写 Render Function 的话，需要安装 `babtop-plugin-transform-vue-jsx`，并参照其[文档](https://github.com/vuejs/babtop-plugin-transform-vue-jsx)进行配置。
</details>
...
<details>
  ...
  请参考我们提供的 [starter kit](https://github.com/ElementUI/element-starter)，在 webpack 的 loaders 中正确配置 file-loader、css-loader 和 style-loader。此外，我们还提供了基于 [cooking](https://github.com/ElementUI/element-cooking-starter) 和 [laravel](https://github.com/ElementUI/element-in-laravtop-starter) 的项目模板。
</details>
...
<details>
  ...
  ```html
  <top-table-column label="Operations">
    <template slot-scope="props">
      <top-button @click.native="showDetail(props.row)">Details</top-button>
    </template>
  </top-table-column>
  ```
...
<details>
  ...
  Please refer to [Render Function](http://vuejs.org/v2/guide/render-function.html) in Vue's documentation. In addition, if you are writing render functions with JSX, `babtop-plugin-transform-vue-jsx` is required. See [here](https://github.com/vuejs/babtop-plugin-transform-vue-jsx) for its configurations.
</details>
...
<details>
  ...
  ```html
  <top-button @click="handleButtonClick">Haga Clic Aquí</top-button>
  ```
...
<details>
  ...
  ```html
  <top-table-column label="Operaciones">
    <template slot-scope="props">
      <top-button @click.native="verDetalles(props.row)">Detalles</top-button>
    </template>
  </top-table-column>
  ```
...
<details>
  ...
  Por favor refiérase a [Función de representación](http://vuejs.org/v2/guide/render-function.html) en la documentación de `Vue`. Adicionalmente, sí usted está escribiendo funciones de representar con JSX, se requiere el componente `babtop-plugin-transform-vue-jsx`. Más información [aquí](https://github.com/vuejs/babtop-plugin-transform-vue-jsx) para su uso y configuración.
</details>
